...
def generate_excel():
    ...
    tiers = [
        ...
        {"name": "Performance Load Test", "results_path": "load_testing/load_test_cases.json", "sheet_name": "Load Performance Tests", "prefix": "TC_LOAD"}
    ]
    ...
    t_cell = ws_dash["A1"]
    t_cell.value = "PLANT DOCTOR - QA AUTOMATION EXECUTION BOARD"
    ...
    # Save to disk
    report_filename = "Plant_Doctor_Test_Report.xlsx"
